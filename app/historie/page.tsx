import { PageLayout, BlogArticle, ImageBoxMultiple } from "@/components/grensverkenner"
          ...
          images={[
            {
              ...
              caption: "De Hertog van Brabant"
            },
            {
              src: "/images/pages/jan3.jpg",
              caption: "De Heer van Breda"
            }
          ]}
        />
