      ...
      <article className="relative">
          ...
          <p className="font-serif text-xl md:text-2xl text-stone-700 inline-block relative">
            <span className="relative">
              ...
              <span className="relative inline-block">
                <span className="relative z-10">uit van natuurlijke dood</span>
        ...
        <div className="grid md:grid-cols-2 gap-6 text-sm leading-relaxed text-stone-800 border-t border-stone-300 pt-6">
          <div className="space-y-4">
            ...
            <p>
              Bekenden van Vermeer reageren geschokt op zijn overlijden. Volgens hen verkeerde hij in goede gezondheid en waren er geen bekende medische problemen.
            </p>
          </div>
          <div className="space-y-4">
            <p>
              De autoriteiten gaan uit van een natuurlijke dood en doen geen verder onderzoek. Verdere details zijn op dit moment niet bekend.
            </p>
            <p>
              Nabestaanden hebben nog geen commentaar gegeven. Informatie over de uitvaart zal later worden bekendgemaakt.
            </p>
            <p className="italic text-stone-600">
              De redactie herdenkt het werk van Viktor Vermeer en respecteert de privacy van zijn familie en naasten.
            </p>
          </div>
        </div>
      </article>
